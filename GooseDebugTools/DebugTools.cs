...
namespace GooseDebugTools
{
    static class DebugTools
    {
        ...
        public static SolidBrush _brushBlack = new SolidBrush(_background),
            _brushGreen = new SolidBrush(_text);
        ...
        public static void OutputLine(GooseEntity g, Graphics graph, int lineNum, string txt)
        {
            ...
            graph.FillRectangle(_brushBlack, new Rectangle(Point.Round(txtPos), txtLen));
            graph.DrawString(txt, SystemFonts.DefaultFont, _brushGreen, txtPos);
